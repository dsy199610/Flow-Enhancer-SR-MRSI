...
def train_epoch(args, epoch, model, data_loader, optimizer, writer):
    ...
    for iter, data in enumerate(data_loader):
        ...
        #print(args.L1_weight, args.SSIM_weight, lowRes)
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
...
def create_arg_parser():
    ...
    parser.add_argument('--exp-dir', type=str, default='checkpoints/NormalizingFlow/newdata', help='Path to save models and results')
